const MODULE_CATALOG = [
  ...
  { key: 'inventory', label: 'Inventory', type: 'module', routePrefixes: ['/item-categories', '/units', '/items', '/warehouses', '/stock-balances', '/stock-movements', '/stock-adjustments', '/stock-receipts', '/carton-lots', '/open-carton-shelves', '/packaging-groups', '/packaging-operations', '/ready-stock', '/sale-catalog'] },
  { key: 'inventory.items', parentKey: 'inventory', label: 'Items', type: 'feature', routePrefixes: ['/items'] },
  { key: 'inventory.packaging', parentKey: 'inventory', label: 'Packaging and ready stock', type: 'feature', routePrefixes: ['/packaging-groups', '/packaging-operations', '/ready-stock', '/sale-catalog'] },
  ...
  { key: 'invoices', label: 'Invoices', type: 'module', routePrefixes: ['/invoices'] },
  { key: 'pos', label: 'Mini POS', type: 'module', routePrefixes: ['/pos'] },
  // `/pos/workspace` deliberately belongs to this separate module even
  // though the endpoint lives beside Mini POS routes.  A store can enable the
  // salesman workspace without granting the broader POS module.
  { key: 'salesman_workspace', label: 'Salesman workspace', type: 'module', routePrefixes: ['/salesman-workspace', '/pos/workspace'] },
  ...
  { key: 'commissions.payroll', parentKey: 'commissions', label: 'Monthly payroll', type: 'feature', routePrefixes: ['/commission-payroll'] },
  ...
  { key: 'reports.normal-stock', parentKey: 'reports', label: 'Normal stock', type: 'feature', routePrefixes: ['/reports/normal-stock'] },
  { key: 'reports.packaging-stock', parentKey: 'reports', label: 'Packaging stock', type: 'feature', routePrefixes: ['/reports/packaging-stock'] },
  { key: 'reports.ready-stock', parentKey: 'reports', label: 'Ready stock', type: 'feature', routePrefixes: ['/reports/ready-stock'] },
  ...
  { key: 'reports.invoices', parentKey: 'reports', label: 'Invoices', type: 'feature', routePrefixes: ['/reports/invoices'] },
  { key: 'reports.gifts', parentKey: 'reports', label: 'Gift COGS', type: 'feature', routePrefixes: ['/reports/gifts'] },
  { key: 'reports.salesman-performance', parentKey: 'reports', label: 'Salesman performance', type: 'feature', routePrefixes: ['/reports/salesman-performance'] },
  ...
  { key: 'reports.packaging-operations', parentKey: 'reports', label: 'Packaging operations', type: 'feature', routePrefixes: ['/reports/packaging-operations'] },
