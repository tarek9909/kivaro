...
router.get('/commission-rules', requireAnyPermission('commissions.manage', 'salesmen.manage'), validate(schemas.listSchema), asyncHandler(controller.listRules));
...
router.get('/commission-payroll', requirePermission('commissions.manage'), validate(schemas.payrollListSchema), asyncHandler(controller.listPayroll));
router.post('/commission-payroll/:salesmanId/pay', requirePermission('commissions.manage'), validate(schemas.payrollPaySchema), asyncHandler(controller.payPayroll));
