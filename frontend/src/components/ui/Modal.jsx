...
/**
 * Accessible glassmorphism modal with backdrop, escape-to-close, and focus trap basics.
 */
export function Modal({
  ...
  return createPortal(
    <div
      ...
      className="fixed inset-0 z-50 flex items-end justify-center px-3 pb-3 pt-16 sm:items-center sm:p-6"
    >
      <button
        type="button"
      ...
      <div
        className={cn(
          'glass-panel-strong relative z-10 flex max-h-[90vh] w-full flex-col overflow-hidden animate-fade-in',
          SIZES[size]
        )}
      >
