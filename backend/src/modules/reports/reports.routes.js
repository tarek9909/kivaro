...
router.get('/reports/cash-reconciliation', report(controller.cashReconciliation));
router.get('/reports/delivery-closeouts', report(controller.deliveryCloseouts));
router.get('/reports/discounts', report(controller.discounts));
router.get('/reports/returns', report(controller.returns));
router.get('/reports/vat-summary', report(controller.vatSummary));
router.get('/reports/product-profitability', report(controller.productProfitability));
router.get('/reports/order-pipeline', report(controller.orderPipeline));
router.get('/reports/inventory-aging', report(controller.inventoryAging));
router.get('/reports/customer-profitability', report(controller.customerProfitability));
router.get('/reports/territory-profitability', report(controller.territoryProfitability));
