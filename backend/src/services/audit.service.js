...
const MODULE_ALIASES = {
  ...
  'item-variants': 'inventory',
  items: 'inventory',
  'packaging-assignments': 'inventory',
  'packaging-configurations': 'production',
  'packaging-group-components': 'inventory',
...
const TABLE_ALIASES = {
  ...
  'packaging-assignments': 'packaging_group_assignments',
  'packaging-configurations': 'packaging_configurations',
  'packaging-group-components': 'packaging_group_components',
